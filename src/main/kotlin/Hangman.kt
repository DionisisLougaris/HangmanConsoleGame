...
val poolOfWords = listOf("Stove","Doctor","Antidote","Basketball","Highlights",
        "Hairdresser","Anaconda","Iron","Whiskey","Schedule","Pillow","Policeman",
        "Donut","Candle","Glass","Zoo","Algebra")
var word = ""
...
fun setupGame() {
    val wordIndex = Random.nextInt(poolOfWords.size)
    word = poolOfWords[wordIndex].toUpperCase()
